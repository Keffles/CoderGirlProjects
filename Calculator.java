...
public class Calculator {
    ...
    public static void main(String[] args)
    {
        ...
        //because the multiiply() method is incomplete.  Fix it!

        out.println("3 times 3 equals " + multiply(3,3));
        out.println("2 times 4 equals " + multiply (2,4));

        //Now it's my turn!  Create a divide() method and write some
        // print statements to test that it works right.

        out.println("16 divided by 4 equals " + divide(16,4));
        out.println("144 divided by 12 equals " + divide(144,12));
    }
}
